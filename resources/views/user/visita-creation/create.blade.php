                ...
                <div class="forms border">
                        <form data-parsley-validate method="POST" action="{{ route('visita.store') }}">
                            ...
                            <div class="form-group">
                                    ...
                                    <!-- Visitante -->
                                    <label>Nome</label>
                                    <input type="text" name="name" disabled value="{{$visitante->name}}" required class="form-control">
                                    <label>Sobrenome</label>
                                    <input type="text" name="surname" disabled value="{{$visitante->surname}}" required class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <label>Bloco</label>
                                <select name="blocoview" disabled class="form-control" required>
                                ...
                                <select name="apartamentoview" disabled class="form-control" required>
