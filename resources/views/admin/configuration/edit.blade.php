...
<div class="row">
        <div class="col-md-6 offset-md-3">
            <div class="forms border">
                <h3 class="text-center">Edição de configurações!</h3>
                <form data-parsley-validate method="POST" action="{{route('admin.config.update')}}">
                        ...
                        <div class="form-group">
                            ...
                            <select name="visitor_car" class="form-control" id="visitor_car" required>
                                <option value="1" class="form-control" @if(old('visitor_car') == 1 && old('resident_registry') != null) selected @elseif($configs->visitor_car == 1) selected @endif>Sim</option>
                                <option value="0" class="form-control" @if(old('visitor_car') == 0 && old('resident_registry') != null) selected @elseif($configs->visitor_car == 0) selected @endif>Não</option>
                            </select>
                            ...
                            <select name="resident_registry" class="form-control" required>
                                <option value="1" class="form-control" @if(old('resident_registry') == 1 && old('resident_registry') != null) selected @elseif($configs->resident_registry == 1) selected @endif>Sim</option>
                                <option value="0" class="form-control" @if(old('resident_registry') == 0 && old('resident_registry') != null) selected @elseif($configs->resident_registry == 0) selected @endif>Não</option>
                            </select>
                        </div>
